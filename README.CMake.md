...
Disabling hard-coding of identified font directories can be configured with (example for macOS fonts):

```
cmake .. -DCMAKE_BUILD_TYPE=Release -DMAGICK_APPLE_FONT_DIR=OFF
```
